...
import com.openaf.browser.gui.utils.BrowserUtils,BrowserUtils._
...
class BrowserStageManager extends JApplication {
  ...
  private def applications = cache(InternalBrowserCacheKey.ApplicationsKey)
...
//      removeStyleSheetsFromScenes(removedOpenAFApplication.styleSheets, scenes :_*) // Causes null pointer - figure out what to do with this
      val currentApplications = cache(InternalBrowserCacheKey.ApplicationsKey)
